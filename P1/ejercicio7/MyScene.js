...
class MyScene extends THREE.Scene {
	constructor(myCanvas) {
		...
		// this.pendulo = new Pendulo(this.gui, "Objeto Pendulo");

		// this.add(this.pendulo);

		this.figura = new Figura(this.gui, "Objeto Pendulo");
	...
	createCamera() {
		...
		this.camera.position.set(5, 0, 60);
		// Y hacia dónde mira
