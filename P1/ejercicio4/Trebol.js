...
class Trebol extends THREE.Object3D {
  constructor(gui) {
    ...
    //Comenzando "el pie" de la figura
    shape.quadraticCurveTo(0.29,0.605,0.588,1.513);
    shape.lineTo(0.588,3.328);

    //circulos con absarc (muy a ojo)
    shape.absarc(1.42848,5.4,2.4,4.3,2.292);

    shape.absarc(0,8.76,2.28,5.75,4.8);

    shape.absarc(-1.42848,5.4,2.4,0.785,5.15);
 
    //Cerrando el pie de la figura
